...
category_bp.route('/<string:category_id>', methods=['GET'])(get_category)
category_bp.route('/<string:category_id>', methods=['PUT'])(update_category)
category_bp.route('/<string:category_id>', methods=['DELETE'])(delete_category)
